(function () {
	...
	(function (exports) {
	  ...
	  exports.Util = {
	    ...
	    _prepareToStringify: function _prepareToStringify(obj) {
	      ...
	      for (var key in obj) {
	        if (!(obj.hasOwnProperty(key) && obj[key] && _typeof$2(obj[key]) == 'object')) {
	          continue;
	        }
	...
	function getNumberValidator() {
	  if (Global_1$c.Konva.isUnminified) {
	...
	var Context = /*#__PURE__*/function () {
	  function Context(canvas) {
	    ...
	    this.canvas = canvas;
	    if (Global_1$b.Konva.enableTrace) {
	      this.traceArr = [];
	      this._enableTrace();
	    }
	  }
	...
	var SceneContext = /*#__PURE__*/function (_Context) {
	  ...
	  function SceneContext(canvas) {
	    ...
	    _this = _callSuper$b(this, SceneContext, [canvas]);
	...
	var HitContext = /*#__PURE__*/function (_Context2) {
	  ...
	  function HitContext(canvas) {
	    ...
	    _this2 = _callSuper$b(this, HitContext, [canvas]);
	...
	function getDevicePixelRatio() {
	  ...
	  _pixelRatio = function () {
	    var devicePixelRatio = Global_1$a.Konva._global.devicePixelRatio || 1,
	...
	var Canvas = /*#__PURE__*/function () {
	  function Canvas(config) {
	    ...
	    this.isCache = false;
	    var conf = config || {};
	    var pixelRatio = conf.pixelRatio || Global_1$a.Konva.pixelRatio || getDevicePixelRatio();
	...
	Factory_1$7.Factory.addGetterSetter(Canvas, 'pixelRatio', undefined, (0, Validators_1$7.getNumberValidator)());
	var SceneCanvas = /*#__PURE__*/function (_Canvas) {
	  ...
	  function SceneCanvas() {
	    ...
	    _this = _callSuper$a(this, SceneCanvas, [config]);
	...
	var HitCanvas = /*#__PURE__*/function (_Canvas2) {
	  ...
	  function HitCanvas() {
	    ...
	    _this2 = _callSuper$a(this, HitCanvas, [config]);
	...
	var Node = /*#__PURE__*/function () {
	  ...
	  _createClass(Node, [{
	          ...
	          try {
	            ...
	            for (n = 0; n < len; n++) {
	              ...
	              if (typeof filter !== 'function') {
	                Util_1$6.Util.error('Filter should be type of function, but got ' + _typeof$2(filter) + ' instead. Please check correct filters');
	                continue;
	              }
	    ...
	    value: function shouldDrawHit(top) {
	      ...
	      var dragSkip = !skipDragCheck && !Global_1$9.Konva.hitOnDragEnabled && layerUnderDrag;
	    ...
	    value: function _getTransform() {
	      ...
	      var x = this.x(),
	        y = this.y(),
	        rotation = Global_1$9.Konva.getAngle(this.rotation()),
	    ...
	    value: function getDragDistance() {
	      if (this.attrs.dragDistance !== undefined) {
	        ...
	        return Global_1$9.Konva.dragDistance;
	      }
	    }
	  }, {
	    key: "_off",
	    ...
	    value: function _requestDraw() {
	      if (Global_1$9.Konva.autoDrawEnabled) {
	    ...
	    value: function _listenDrag() {
	      ...
	      this.on('mousedown.konva touchstart.konva', function (evt) {
	        ...
	        var canDrag = !shouldCheckButton || Global_1$9.Konva.dragButtons.indexOf(evt.evt['button']) >= 0;
	        if (!canDrag) {
	          return;
	        }
	        if (this.isDragging()) {
	...
	var addGetterSetter = Factory_1$6.Factory.addGetterSetter;
	addGetterSetter(Node, 'zIndex');
	addGetterSetter(Node, 'absolutePosition');
	addGetterSetter(Node, 'position');
	addGetterSetter(Node, 'x', 0, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'y', 0, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'globalCompositeOperation', 'source-over', (0, Validators_1$6.getStringValidator)());
	addGetterSetter(Node, 'opacity', 1, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'name', '', (0, Validators_1$6.getStringValidator)());
	addGetterSetter(Node, 'id', '', (0, Validators_1$6.getStringValidator)());
	addGetterSetter(Node, 'rotation', 0, (0, Validators_1$6.getNumberValidator)());
	Factory_1$6.Factory.addComponentsGetterSetter(Node, 'scale', ['x', 'y']);
	addGetterSetter(Node, 'scaleX', 1, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'scaleY', 1, (0, Validators_1$6.getNumberValidator)());
	Factory_1$6.Factory.addComponentsGetterSetter(Node, 'skew', ['x', 'y']);
	addGetterSetter(Node, 'skewX', 0, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'skewY', 0, (0, Validators_1$6.getNumberValidator)());
	Factory_1$6.Factory.addComponentsGetterSetter(Node, 'offset', ['x', 'y']);
	addGetterSetter(Node, 'offsetX', 0, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'offsetY', 0, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'dragDistance', null, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'width', 0, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'height', 0, (0, Validators_1$6.getNumberValidator)());
	addGetterSetter(Node, 'listening', true, (0, Validators_1$6.getBooleanValidator)());
	addGetterSetter(Node, 'preventDefault', true, (0, Validators_1$6.getBooleanValidator)());
	addGetterSetter(Node, 'filters', null, function (val) {
	  this._filterUpToDate = false;
	  return val;
	});
	addGetterSetter(Node, 'visible', true, (0, Validators_1$6.getBooleanValidator)());
	addGetterSetter(Node, 'transformsEnabled', 'all', (0, Validators_1$6.getStringValidator)());
	addGetterSetter(Node, 'size');
	addGetterSetter(Node, 'dragBoundFunc');
	addGetterSetter(Node, 'draggable', false, (0, Validators_1$6.getBooleanValidator)());
	Factory_1$6.Factory.backCompat(Node, {
	  rotateDeg: 'rotate',
	...
	var Container = /*#__PURE__*/function (_Node_1$Node) {
	  ...
	  function Container() {
	    ...
	    _this = _callSuper$9(this, Container, arguments);
	    _this.children = [];
	    return _this;
	  }
	...
	Factory_1$5.Factory.addComponentsGetterSetter(Container, 'clip', ['x', 'y', 'width', 'height']);
	Factory_1$5.Factory.addGetterSetter(Container, 'clipX', undefined, (0, Validators_1$5.getNumberValidator)());
	Factory_1$5.Factory.addGetterSetter(Container, 'clipY', undefined, (0, Validators_1$5.getNumberValidator)());
	Factory_1$5.Factory.addGetterSetter(Container, 'clipWidth', undefined, (0, Validators_1$5.getNumberValidator)());
	Factory_1$5.Factory.addGetterSetter(Container, 'clipHeight', undefined, (0, Validators_1$5.getNumberValidator)());
	Factory_1$5.Factory.addGetterSetter(Container, 'clipFunc');
	...
	var SUPPORT_POINTER_EVENTS = Global_1$8.Konva._global['PointerEvent'] !== undefined;
	...
	(function (exports) {
	  ...
	  var Stage = /*#__PURE__*/function (_Container_1$Containe) {
	    ...
	    function Stage(config) {
	      ...
	      _this = _callSuper$8(this, Stage, [checkNoClip(config)]);
	...
	(function (exports) {
	  ...
	  var Shape = /*#__PURE__*/function (_Node_1$Node) {
	    ...
	    function Shape(config) {
	      ...
	      _this = _callSuper$7(this, Shape, [config]);
	      var key;
	      while (true) {
	...
	var Layer = /*#__PURE__*/function (_Container_1$Containe) {
	  ...
	  function Layer(config) {
	    ...
	    _this = _callSuper$6(this, Layer, [config]);
	  ...
	  _createClass(Layer, [{
	    ...
	    value: function _getIntersection(pos) {
	      ...
	      if (p3 === 255) {
	        ...
	        var shape = Shape_1$4.shapes[HASH + colorKey];
	        if (shape) {
	          return {
	            shape: shape
	          };
	...
	(0, Global_1$7._registerNode)(Layer);
	Factory_1$4.Factory.addGetterSetter(Layer, 'imageSmoothingEnabled', true);
	Factory_1$4.Factory.addGetterSetter(Layer, 'clearBeforeDraw', true);
	Factory_1$4.Factory.addGetterSetter(Layer, 'hitGraphEnabled', true, (0, Validators_1$4.getBooleanValidator)());
	...
	var FastLayer = /*#__PURE__*/function (_Layer_1$Layer) {
	  ...
	  function FastLayer(attrs) {
	    ...
	    _this = _callSuper$5(this, FastLayer, [attrs]);
	...
	(0, Global_1$6._registerNode)(FastLayer);
	...
	var Group = /*#__PURE__*/function (_Container_1$Containe) {
	  ...
	  function Group() {
	    ...
	    return _callSuper$4(this, Group, arguments);
	  }
	  _createClass(Group, [{
	    key: "_validateAdd",
	    value: function _validateAdd(child) {
	...
	(0, Global_1$5._registerNode)(Group);
	...
	var Util_1$2 = Util;
	var now = function () {
	  if (Global_1$4.glob.performance && Global_1$4.glob.performance.now) {
	    return function () {
	      return Global_1$4.glob.performance.now();
	    };
	  }
	  return function () {
	...
	var Line = /*#__PURE__*/function (_Shape_1$Shape) {
	  ...
	  function Line(config) {
	    ...
	    _this = _callSuper$3(this, Line, [config]);
	...
	(0, Global_1$3._registerNode)(Line);
	Factory_1$3.Factory.addGetterSetter(Line, 'closed', false);
	Factory_1$3.Factory.addGetterSetter(Line, 'bezier', false);
	Factory_1$3.Factory.addGetterSetter(Line, 'tension', 0, (0, Validators_1$3.getNumberValidator)());
	Factory_1$3.Factory.addGetterSetter(Line, 'points', [], (0, Validators_1$3.getNumberArrayValidator)());
	...
	var Rect = /*#__PURE__*/function (_Shape_1$Shape) {
	  ...
	  function Rect() {
	    ...
	    return _callSuper$2(this, Rect, arguments);
	  }
	  _createClass(Rect, [{
	    key: "_sceneFunc",
	    value: function _sceneFunc(context) {
	...
	(0, Global_1$2._registerNode)(Rect);
	Factory_1$2.Factory.addGetterSetter(Rect, 'cornerRadius', 0, (0, Validators_1$2.getNumberOrArrayOfNumbersValidator)(4));
	...
	var Text = /*#__PURE__*/function (_Shape_1$Shape) {
	  ...
	  function Text(config) {
	    ...
	    _this = _callSuper$1(this, Text, [checkDefaultFill(config)]);
	  ...
	  _createClass(Text, [{
	    ...
	    value: function _getContextFont() {
	      return this.fontStyle() + SPACE$1 + this.fontVariant() + SPACE$1 + (this.fontSize() + PX_SPACE) + normalizeFontFamily(this.fontFamily());
	    }
	  }, {
	    key: "_addTextLine",
	...
	(0, Global_1$1._registerNode)(Text);
	Factory_1$1.Factory.overWriteSetter(Text, 'width', (0, Validators_1$1.getNumberOrAutoValidator)());
	Factory_1$1.Factory.overWriteSetter(Text, 'height', (0, Validators_1$1.getNumberOrAutoValidator)());
	Factory_1$1.Factory.addGetterSetter(Text, 'fontFamily', 'Arial');
	Factory_1$1.Factory.addGetterSetter(Text, 'fontSize', 12, (0, Validators_1$1.getNumberValidator)());
	Factory_1$1.Factory.addGetterSetter(Text, 'fontStyle', NORMAL);
	Factory_1$1.Factory.addGetterSetter(Text, 'fontVariant', NORMAL);
	Factory_1$1.Factory.addGetterSetter(Text, 'padding', 0, (0, Validators_1$1.getNumberValidator)());
	Factory_1$1.Factory.addGetterSetter(Text, 'align', LEFT$1);
	Factory_1$1.Factory.addGetterSetter(Text, 'verticalAlign', TOP);
	Factory_1$1.Factory.addGetterSetter(Text, 'lineHeight', 1, (0, Validators_1$1.getNumberValidator)());
	Factory_1$1.Factory.addGetterSetter(Text, 'wrap', WORD);
	Factory_1$1.Factory.addGetterSetter(Text, 'ellipsis', false, (0, Validators_1$1.getBooleanValidator)());
	Factory_1$1.Factory.addGetterSetter(Text, 'letterSpacing', 0, (0, Validators_1$1.getNumberValidator)());
	Factory_1$1.Factory.addGetterSetter(Text, 'text', '', (0, Validators_1$1.getStringValidator)());
	Factory_1$1.Factory.addGetterSetter(Text, 'textDecoration', '');
	...
	function isJsonWaveformData(data) {
	  return data && _typeof$1(data) === "object" && "sample_rate" in data && "samples_per_pixel" in data && "bits" in data && "length" in data && "data" in data;
	}
	function isBinaryWaveformData(data) {
	  var isCompatible = data && _typeof$1(data) === "object" && "byteLength" in data;
	  if (isCompatible) {
	...
	function createSegmentMarker$1(options) {
	...
	function createSegmentLabel$1(options) {
	  return new Text_2({
	    x: 12,
	    y: 12,
	...
	function createPointMarker$1(options) {
	...
	function Peaks() {
	  ...
	  this.options = {
	    ...
	    createSegmentMarker: createSegmentMarker$1,
	    createSegmentLabel: createSegmentLabel$1,
	    createPointMarker: createPointMarker$1,
	...
	var Tag_1 = Label$1.Tag = Label_2 = Label$1.Label = void 0;
	var Factory_1 = Factory;
	var Shape_1 = Shape;
	var Group_1 = Group$1;
	var Validators_1 = Validators;
	...
	var Label = /*#__PURE__*/function (_Group_1$Group) {
	  _inherits(Label, _Group_1$Group);
	  function Label(config) {
	    var _this;
	    _classCallCheck(this, Label);
	    _this = _callSuper(this, Label, [config]);
	...
	var Label_2 = Label$1.Label = Label;
	Label.prototype.className = 'Label';
	(0, Global_1._registerNode)(Label);
	var Tag = /*#__PURE__*/function (_Shape_1$Shape) {
	  _inherits(Tag, _Shape_1$Shape);
	  function Tag() {
	...
	var CustomPointMarker = /*#__PURE__*/function () {
	  function CustomPointMarker(options) {
	    _classCallCheck(this, CustomPointMarker);
	    this._options = options;
	  }
	  _createClass(CustomPointMarker, [{
	    key: "init",
	    value: function init(group) {
	      this._group = group;
	      this._label = new Label_2({
	        x: 0.5,
	        y: 0.5
	      });
	      this._tag = new Tag_1({
	  ...
	  return CustomPointMarker;
	}();

	var SimplePointMarker = /*#__PURE__*/function () {
	  function SimplePointMarker(options) {
	    _classCallCheck(this, SimplePointMarker);
	    this._options = options;
	  }
	  _createClass(SimplePointMarker, [{
	    key: "init",
	    value: function init(group) {
	      this._group = group;
	...
	var CustomSegmentMarker = /*#__PURE__*/function () {
	  function CustomSegmentMarker(options) {
	    _classCallCheck(this, CustomSegmentMarker);
	    this._options = options;
	  }
	  _createClass(CustomSegmentMarker, [{
	    key: "init",
	    value: function init(group) {
	      this._group = group;
	      this._label = new Label_2({
	...
	function renderSegments(peaks) {
	  ...
	  for (var i = 0; i < segments.length; i++) {
	    ...
	    var row = '<tr>' + '<td>' + segment.id + '</td>' + '<td><input data-action="update-segment-label" type="text" value="' + segment.labelText + '" data-id="' + segment.id + '"/></td>' + '<td><input data-action="update-segment-start-time" type="number" value="' + segment.startTime + '" data-id="' + segment.id + '"/></td>' + '<td><input data-action="update-segment-end-time" type="number" value="' + segment.endTime + '" data-id="' + segment.id + '"/></td>' + '<td>' + '<a href="#' + segment.id + '" data-action="play-segment" data-id="' + segment.id + '">Play</a>' + '</td>' + '<td>' + '<a href="#' + segment.id + '" data-action="remove-segment" data-id="' + segment.id + '">Remove</a>' + '</td>' + '</tr>';
	    html += row;
	  }
	...
	function renderPoints(peaks) {
	  ...
	  for (var i = 0; i < points.length; i++) {
	    var point = points[i];
	    var row = '<tr>' + '<td>' + point.id + '</td>' + '<td><input data-action="update-point-label" type="text" value="' + point.labelText + '" data-id="' + point.id + '"/></td>' + '<td><input data-action="update-point-time" type="number" value="' + point.time + '" data-id="' + point.id + '"/></td>' + '<td>' + '<a href="#' + point.id + '" data-action="remove-point" data-id="' + point.id + '">Remove</a>' + '</td>' + '</tr>';
	    html += row;
	  }
...
//# sourceMappingURL=custom-markers.js.map
