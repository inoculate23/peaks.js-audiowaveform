(function (global, factory) {
  ...
  function SegmentMarker(options) {
    ...
    self._group = new Konva__default["default"].Group({
      name: 'segment-marker',
  ...
  function SegmentShape(segment, peaks, layer, view) {
    ...
    this._overlayRect = new Konva__default["default"].Rect({
      x: 0,
    ...
    if (segmentOptions.overlay) {
      this._overlayText = new Konva__default["default"].Text({
        x: 0,
        y: this._overlayOffset,
  ...
  WaveformView.prototype._createWaveform = function () {
    this._waveformLayer = new Konva__default["default"].Layer({
      listening: false
    });
  ...
  function Scrollbar(waveformData, container, peaks) {
    ...
    this._stage = new Konva__default["default"].Stage({
      container: container,
      width: this._width,
      height: this._height
    });
    ...
    this._offsetY = 0;
    this._scrollbox = new Konva__default["default"].Group({
      draggable: true,
      dragBoundFunc: this._dragBoundFunc
    });
